...
public class MapGenWaterTree extends WorldGenerator
{
    public MapGenWaterTree(boolean par1)
    {
        super(par1);
    }
                ...
                for (j1 = par3 - b0; j1 <= par3 + b0 && flag; ++j1)
                {
                    for (k1 = par5 - b0; k1 <= par5 + b0 && flag; ++k1)
                    {
                        if (i1 >= 0 && i1 < 256)
                        {
                            ...
                            if (l1 != Block.waterStill.blockID && (block != null && !block.isLeaves(par1World, j1,  i1, k1)) && l1 != Block.waterMoving.blockID)
                            {
                                flag = false;
                            }
                        }
