...
public class RenderSpitBall extends Render
{
    private static final ResourceLocation field_110780_a = new ResourceLocation(Strings.toLowerCase(Utils.MAIN_MOD_ID)+":textures/mob/SpitBall.png");
