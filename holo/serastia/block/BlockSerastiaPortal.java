...
public class BlockSerastiaPortal extends BlockBreakable
{
    public BlockSerastiaPortal(int par1)
    {
        super(par1, Strings.toLowerCase(Utils.MAIN_MOD_ID) + ":SerastiaPortal", Material.portal, false);
    ...
    public boolean tryToCreatePortal(World par1World, int par2, int par3, int par4)
    {
        ...
        if (par1World.getBlockId(par2 - 1, par3, par4) == Block.wood.blockID || par1World.getBlockId(par2 + 1, par3, par4) == Block.wood.blockID)
        {
            b0 = 1;
        }

        if (par1World.getBlockId(par2, par3, par4 - 1) == Block.wood.blockID || par1World.getBlockId(par2, par3, par4 + 1) == Block.wood.blockID)
        {
            b1 = 1;
        }
    ...
    public void onNeighborBlockChange(World par1World, int par2, int par3, int par4, int par5)
    {
        ...
        if (par1World.getBlockId(par2, i1 - 1, par4) != Block.wood.blockID)
        {
        ...
        else
        {
            ...
            if (j1 == 3 && par1World.getBlockId(par2, i1 + j1, par4) == Block.wood.blockID)
            {
                ...
                {
                    if ((par1World.getBlockId(par2 + b0, par3, par4 + b1) != Block.wood.blockID || par1World.getBlockId(par2 - b0, par3, par4 - b1) != this.blockID) && (par1World.getBlockId(par2 - b0, par3, par4 - b1) != Block.wood.blockID || par1World.getBlockId(par2 + b0, par3, par4 + b1) != this.blockID))
                    {
                        par1World.setBlockToAir(par2, par3, par4);
                    }
                }
